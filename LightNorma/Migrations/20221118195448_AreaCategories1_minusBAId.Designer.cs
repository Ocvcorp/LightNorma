...
namespace LightNorma.Migrations
{
    ...
    [Migration("20221118195448_AreaCategories1_minusBAId")]
    partial class AreaCategories1_minusBAId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LightNorma.Models.AreaPlaceCategory0", b =>
                {
                    ...
                    b.HasIndex("AreaPlaceCategory1Id");
            ...
            modelBuilder.Entity("LightNorma.Models.AreaPlaceCategory1", b =>
                {
                    ...
                    b.HasIndex("BaseAppilcationCategoryId");
            ...
            modelBuilder.Entity("LightNorma.Models.AreaPlaceCategory0", b =>
                {
                    b.HasOne("LightNorma.Models.AreaPlaceCategory1", "AreaPlaceCategory1")
                        .WithMany("AreaPlaceCategories0")
                        .HasForeignKey("AreaPlaceCategory1Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AreaPlaceCategory1");
                });

            modelBuilder.Entity("LightNorma.Models.AreaPlaceCategory1", b =>
                {
                    b.HasOne("LightNorma.Models.BaseAppilcationCategory", "BaseAppilcationCategory")
                        .WithMany("AreaPlaceCategories1")
                        .HasForeignKey("BaseAppilcationCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BaseAppilcationCategory");
                });
            ...
            modelBuilder.Entity("LightNorma.Models.BaseAppilcationCategory", b =>
                {
                    b.Navigation("AreaPlaceCategories1");
                });
